...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 28, fontWeight: '800', fontFamily: 'SpaceGrotesk-Bold', color: '#111827', letterSpacing: -0.5 },
  headerSubtitle: { fontSize: 14, fontFamily: 'SpaceGrotesk-Regular', color: '#6b7280', marginTop: 4 },
  tabsScroll: {
    backgroundColor: '#ffffff',
    borderBottomWidth: 1,
    borderBottomColor: '#e5e7eb',
  ...
  sectionTitle: { fontSize: 20, fontWeight: '700', fontFamily: 'SpaceGrotesk-Bold', color: '#111827' },
  addButton: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  addButtonText: { color: '#ffffff', fontSize: 14, fontWeight: '600', fontFamily: 'SpaceGrotesk-SemiBold' },
  card: {
    backgroundColor: '#ffffff',
    borderRadius: 12,
    padding: 16,
  ...
  cardTitle: { fontSize: 16, fontWeight: '700', fontFamily: 'SpaceGrotesk-Bold', color: '#111827' },
  cardActions: { flexDirection: 'row', gap: 12 },
  iconButton: { padding: 4 },
  cardContent: { gap: 4 },
  cardText: { fontSize: 14, color: '#6b7280' },
  cardPrice: { fontSize: 18, fontWeight: '700', fontFamily: 'SpaceGrotesk-Bold', color: '#f97316', marginTop: 4 },
  ...
  bankName: { fontSize: 16, fontWeight: '700', fontFamily: 'SpaceGrotesk-Bold', color: '#111827', flex: 1 },
  ...
  areaName: { fontSize: 16, fontWeight: '700', fontFamily: 'SpaceGrotesk-Bold', color: '#111827' },
  ...
  modalTitle: { fontSize: 20, fontWeight: '700', fontFamily: 'SpaceGrotesk-Bold', color: '#111827' },
  input: {
  ...
  modalButtonText: { color: '#ffffff', fontSize: 16, fontWeight: '700', fontFamily: 'SpaceGrotesk-Bold' },
  ...
  saveButtonText: { fontSize: 16, fontWeight: '700', fontFamily: 'SpaceGrotesk-Bold', color: '#ffffff' },
